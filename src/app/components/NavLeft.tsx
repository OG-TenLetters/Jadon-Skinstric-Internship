...
export default function NavLeft({ name, empty, triangleVariant = "black" }: NavLeftProps) {
  ...
  const currentTriangeSrc = triangleVariant === "white" ? WhiteTriangle.src : Triangle.src
